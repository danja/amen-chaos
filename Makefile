# LV2 Chaos Amen Plugin Makefile

# Plugin details
PLUGIN_NAME = chaos-amen
PLUGIN_SO = chaos_amen.so
PLUGIN_URI = http://github.com/yourname/chaos-amen
...
# Source files
SOURCES = chaos_amen.cpp
OBJECTS = $(SOURCES:.cpp=.o)

# TTL files
TTL_FILES = manifest.ttl chaos_amen.ttl
